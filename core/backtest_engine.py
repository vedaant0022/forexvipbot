...
# def backtest_signals(signals, price_data, symbol, atr_series, rr_ratio=2.0, stop_atr=1.0, output_path='reports/'):
#     trades = []
...
#         # Simulate candle-by-candle outcome
...
#         # ✅ Skip trade if neither SL nor TP was hit
